...
class MockHASSFactory:
    ...
    def create_coordinator(
        *,
        ...
        coordinator.get_owner_tier_info = AsyncMock(return_value={"tier": "free", "hasStripeCustomer": False})
        coordinator.start_premium_checkout = AsyncMock(return_value={"url": "https://checkout.stripe.com/c/pay/cs_test", "id": "cs_test"})
        coordinator.start_billing_portal = AsyncMock(return_value={"url": "https://billing.stripe.com/p/session/test", "id": "bps_test"})
