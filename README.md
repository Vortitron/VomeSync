...
- **Premium:** 150 switches / 120 public, via Stripe Checkout (€9 / month including VAT), promo code, or admin grant. Cancel or change card from the switch page or **More → Manage billing** in Home Assistant.
